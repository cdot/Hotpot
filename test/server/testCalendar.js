...
requirejs(["node-getopt", "js/common/Utils", "js/common/DataModel", "js/server/Controller", "js/server/GoogleCalendar"], function(Getopt, Utils, DataModel, Controller, GoogleCalendar) {

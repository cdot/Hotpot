 ...
 */
Utils.exception = (...args) => {
  const e = new Error(Utils.joinArgs(args, 1));
  e.name = args[0];
  return e;
};
 ...
 */
Utils.startTimer = (descr, fn, timeout) => {
